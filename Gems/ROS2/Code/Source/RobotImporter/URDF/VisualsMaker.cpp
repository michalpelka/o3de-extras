        ...
        case urdf::Geometry::MESH:
            {
                ...
                if (asset)
                {
                    ...
                    const auto  productAssetPath = Utils::GetModelProductAsset(asset->m_assetId);
                    AZ_Warning("AddVisual",productAssetPath.size(), "There is no product asset for %s.", asset->m_sourceAssetRelativePath.c_str() );
                    // Set asset path
